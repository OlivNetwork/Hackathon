...
sklearn_kpca = KernelPCA(n_components=500, kernel='cosine', gamma=15)
data_kpca = sklearn_kpca.fit_transform(data)  # 500x500
print(data_kpca)
# a = []
# for i in range(len(data_kpca[0])):
#     if abs(data_kpca[0][i]) > 0.0001:
#         a.append(data_kpca[0][i])
# print(a)
# print(np.shape(a))

# train_data = data_kpca[:, :36]
train_data = data_kpca
